...
def getjsonfile():
    ...
    jsonfileprocess = Popen([r"gwbotwserver/getsoldjsonitemsexe/customereditiongetsolditemsjsonfile.exe"])
...
def startgw2bot():
    global process
    process = Popen("gwbotwserver/customeredition_gw2botwserver.exe")
...
i = Button(root, text="Enter your character ID", command=entercharid)
...
c = Button(root, text="Navigate to your GW2 directory", command=gw2source)
z = Button(root, text="Start Gw2 Trading Bot", command = startgw2bot)
